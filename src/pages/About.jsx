...
const About = () => {
  return (
    <div className="about-container">
      <h2>About Me</h2>
      <p>
        I am Yunus Yıldız, a passionate and dedicated full-stack developer with a strong foundation in web development.
        After completing comprehensive training at HiCoders IT Academy, I gained proficiency in building scalable and
        efficient web applications using modern technologies. I am constantly evolving my skills to deliver better solutions
        and make an impact through technology.
      </p>

      <h3>Education & Certifications</h3>
      <ul className="certifications-list">
        <li>
          <FaCertificate style={{ color: '#ff5733', marginRight: '10px' }} />
      ...
      <h3>Skills and Abilities Acquired</h3>
      <ul className="skills-list">
        <li>Mastery of Web Programming Basics Concepts</li>
      ...
      <p>
        I enjoy playing chess, running, and spending time improving my coding skills. I believe in continuous learning and
        am always curious to explore new technologies and tools to enhance my skill set.
      </p>
    </div>
  );
};
