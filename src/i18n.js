    ...
    resources: {
      en: {
        translation: {
          ...
          "skills.item3": "Expertise in Independently Building Applications Using HTML, CSS, and JavaScript",
          "skills.item4": "Ability to Build and Deploy Full-Stack Applications Using React, Node.js, and MongoDB",
          "skills.item5": "Understanding of CLI Basics, Git, and GitHub",
          "skills.item6": "Strong Ability to Communicate and Articulate Programming Principles",
          "skills.item7": "Basic Knowledge of Arduino Integration and IoT Applications",
          "technicalSkills.title": "Technical Skills",
          "hobbies.title": "Hobbies & Interests",
          "hobbies.description": "I enjoy playing chess, running, drinking coffee with my wife, and spending time improving my coding skills. I believe in continuous learning and am always curious to explore new technologies and tools to enhance my skill set.",
      ...
      de: {
        translation: {
          ...
          "skills.item3": "Expertenwissen im eigenständigen Aufbau von Anwendungen mit HTML, CSS und JavaScript",
          "skills.item4": "Fähigkeit zum Erstellen und Bereitstellen von Full-Stack-Anwendungen mit React, Node.js und MongoDB",
          "skills.item5": "Grundverständnis von CLI, Git und GitHub",
          "skills.item6": "Starke Kommunikationsfähigkeiten und Verständnis von Programmierprinzipien",
          "skills.item7": "Grundkenntnisse in der Arduino-Integration und IoT-Anwendungen",
          "technicalSkills.title": "Technische Fähigkeiten",
          "hobbies.title": "Hobbys & Interessen",
          "hobbies.description": "Ich genieße es, Schach zu spielen, zu laufen, Kaffee mit meiner Frau zu trinken und Zeit damit zu verbringen, meine Programmierfähigkeiten zu verbessern. Ich glaube an lebenslanges Lernen und bin immer neugierig, neue Technologien und Werkzeuge zu erkunden, um meine Fähigkeiten weiterzuentwickeln.",
          "footer.address": "Genf",
          "footer.copyright": "© 2025 Yunus YILDIZ",
